...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $path['css_path'] ?>/style.css" />
    <script type="text/javascript" src="<?php echo $path['js_path'] ?>/clockp.js"></script>
    <script type="text/javascript" src="<?php echo $path['js_path'] ?>/clockh.js"></script>
    <script type="text/javascript" src="<?php echo $path['js_path'] ?>/jquery.min.js"></script>
    <script type="text/javascript" src="<?php echo $path['js_path'] ?>/ddaccordion.js"></script>
    <script type="text/javascript">
        ddaccordion.init({
            ...
            togglehtml: ["suffix", "<img src='<?php echo $path['images_path'] ?>/images/plus.gif' class='statusicon' />", "<img src='<?php echo $path['images_path'] ?>/images/minus.gif' class='statusicon' />"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
    ...
    <script type="text/javascript" src="<?php echo $path['js_path'] ?>/jconfirmaction.jquery.js"></script>
    <script type="text/javascript">
    ...
    <script language="javascript" type="text/javascript" src="<?php echo $path['js_path'] ?>/niceforms.js"></script>
    <link rel="stylesheet" type="text/css" media="all" href="<?php echo $path['css_path'] ?>/niceforms-default.css" />
...
<div class="header">
    <div class="logo"><a href="#"><img src="<?php echo $path['images_path'] ?>/images/logo.gif" alt="" title="" border="0" /></a></div>

    <div class="right_header">Welcome <?php echo $txt['info']['username'] ?>, <a href="#">Visit site</a> | <a href="#" class="messages">(3) Messages</a> | <a href="<?php echo $path['host_path'] ?>/admin/logout" class="logout">Logout</a></div>
    <div id="clock_a"></div>
</div>
...
<div class="left_content">
    ...
    <div class="sidebar_search">
        <form>
            ...
            <input type="image" class="search_submit" src="<?php echo $path['images_path'] ?>/images/search.png" />
        </form>
    </div>
    ...
    <div class="sidebarmenu">
        ...
        <a class="menuitem" href="<?php echo $path['host_path'] ?>/admin/course">Course</a>
    ...
    <div class="sidebar_box">
        ...
        <div class="sidebar_box_content">
            ...
            <img src="<?php echo $path['images_path'] ?>/images/info.png" alt="" title="" class="sidebar_icon_right" />
            <p>
    ...
    <div class="sidebar_box">
        ...
        <div class="sidebar_box_content">
            ...
            <img src="<?php echo $path['images_path'] ?>/images/notice.png" alt="" title="" class="sidebar_icon_right" />
            <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
        </div>
    ...
    <div class="sidebar_box">
        ...
        <div class="sidebar_box_content">
            ...
            <img src="<?php echo $path['images_path'] ?>/images/photo.png" alt="" title="" class="sidebar_icon_right" />
            <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
        </div>
...
<div class="right_content">
    ...
    <table id="rounded-corner" summary="2007 Major IT Companies' Profit">
        ...
        <tr>
            ...
            <td><a href="#"><img src="<?php echo $path['images_path'] ?>/images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="#" class="ask"><img src="<?php echo $path['images_path'] ?>/images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
...
<div class="footer">
    ...
    <div class="right_footer"><a href="http://indeziner.com"><img src="<?php echo $path['images_path'] ?>/images/indeziner_logo.gif" alt="" title="" border="0" /></a></div>
